...
Revision ID: eb3baae7461f
Revises: 
Create Date: 2024-06-15 11:51:50.192566
...
def upgrade():
    ...
    sa.Column('num_class_total', sa.Integer(), nullable=False),
    sa.Column('num_f1', sa.Integer(), nullable=False),
    sa.Column('num_f2', sa.Integer(), nullable=False),
    sa.Column('num_f3', sa.Integer(), nullable=False),
    sa.Column('num_infant', sa.Integer(), nullable=False),
    ...
    sa.Column('machine_model', sa.String(length=10), nullable=False),
    ...
    sa.Column('tool_type', sa.String(length=10), nullable=False),
    sa.Column('tool_model', sa.String(length=20), nullable=False),
    sa.Column('quantity', sa.Integer(), nullable=False),
    sa.Column('price', sa.Numeric(precision=10, scale=2), nullable=False),
    ...
    op.create_table('rent_invoice_histories',
    sa.Column('status', sa.String(length=10), nullable=False),
...
def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_table('rent_invoice_histories')
